...
# Generated on: Mon May 04 01:07:08 +0530 2026 (Sun May 03 19:37:08 GMT 2026)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/test_inverter/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/test_inverter -revised fv_map
...
add_search_path . /home/aed/cadence/Genus181/tools.lnx86/lib/tech -library -both
read_library -liberty -both   /home/user22/sky130_pdk/sky130_scl_9T_0.1.1/sky130_scl_9T/lib/sky130_tt_1.8_25_nldm.lib
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k test_inverter.v
elaborate_design -golden -root {test_inverter} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/test_inverter/fv_map.v.gz
elaborate_design -revised -root {test_inverter}
