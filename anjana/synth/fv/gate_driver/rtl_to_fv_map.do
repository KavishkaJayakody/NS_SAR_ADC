...
# Generated on: Fri Aug 07 06:58:42 +0530 2026 (Fri Aug 07 01:28:42 GMT 2026)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/gate_driver/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/gate_driver -revised fv_map
...
add_search_path /home/user23/Sky130_cadance_pdk/sky130_scl_9T_0.1.1/sky130_scl_9T/lib -library -both
read_library -liberty -both   /home/user23/Sky130_cadance_pdk/sky130_scl_9T_0.1.1/sky130_scl_9T/lib/sky130_tt_1.8_25_nldm.lib
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k rtl/gate_driver.v
elaborate_design -golden -root {gate_driver} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/gate_driver/fv_map.v.gz
elaborate_design -revised -root {gate_driver}
